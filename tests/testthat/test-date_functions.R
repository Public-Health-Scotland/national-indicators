test_that("Financial months are assigned as expected", {
  ...
  expect_equal(calculate_financial_month(lubridate::dmy("11-04-2021")),
               "M1")

  expect_equal(calculate_financial_month(lubridate::dmy("31-03-2021")),
               "M12")

  expect_equal(calculate_financial_month(c(lubridate::dmy("12-12-2015"),
...
test_that("Financial years are calculated correctly", {
  ...
  expect_equal(format_financial_year(c("2015", "2018", "2020")),
