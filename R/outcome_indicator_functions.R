  ...
  indicators <- format_raw_hace_data(raw_list, hace_year) %>%
    dplyr::mutate(
      indicator = dplyr::case_when(
        ...
        stringr::str_detect(.data$description_2024, "In general,") ~ "NI1",
        stringr::str_detect(.data$description_2024, "independently") ~ "NI2",
        stringr::str_detect(.data$description_2024, "had a say") ~ "NI3",
        stringr::str_detect(.data$description_2024, "coordinated") ~ "NI4",
        stringr::str_detect(.data$description_2024, "exclude") ~ "NI5",
        stringr::str_detect(.data$description_2024, "GP") ~ "NI6",
        stringr::str_detect(.data$description_2024, "maintained") ~ "NI7",
        stringr::str_detect(.data$description_2024, "continue") ~ "NI8",
        stringr::str_detect(.data$description_2024, "safe") ~ "NI9",
        TRUE ~ "No"
      ),
      time_period = "Annual",
      year = fin_year,
